        ...
        <form action="#" className="space-y-8">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              id="message"
              rows={6}
              className="block p-2.5 w-full text-sm rounded-lg shadow-sm border focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 dark:placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
